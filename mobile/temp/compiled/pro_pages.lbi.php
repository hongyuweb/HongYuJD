      ...
      <div class="pagenav-content">
        <div class="pagenav" id="J_PageNav">
          ...
          <div class="pagenav-cur" style="vertical-align:bottom">
            <div class="pagenav-text" > <span><?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_72399500_1446387283');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_72399500_1446387283']):
?>
...
<?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_72424800_1446387283');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_72424800_1446387283']):
?>
  <option <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?>selected="selected"<?php endif; ?> value="<?php echo $this->_var['item_0_72424800_1446387283']; ?>">第<?php echo $this->_var['key']; ?>页</option>
