...
?>
                        <li onclick="selectPayment(<?php echo $this->_var['payment']['pay_id']; ?>)" class="clearfix" name="payment_name">
...
?>
  ...
  <div class="pay-btn">
    <a href="weixinpay.php?oid=<?php echo $this->_var['$item']['order_sn']; ?>" class="sub-btn btnRadius">微支付</a>
  </div>
  <?php else: ?>
  <div class="pay-btn">
    <a href="./pay/alipayapi.php?out_trade_no=<?php echo $this->_var['item']['order_sn']; ?>&total_fee=<?php echo $this->_var['total']['amount_formated_wap']; ?>" class="sub-btn btnRadius">去支付宝支付</a>
  </div>
  <?php endif; ?>
    <?php else: ?>
